...
export class Order extends CoreEntity {
    ...
    @ManyToOne(type => User, user => user.orders,{nullable:true, onDelete:'SET NULL'})
    customer?:User
    ...
    @Field(type => User,{nullable:true})
    @ManyToOne(type => User, user => user.rides,{nullable:true, onDelete:'SET NULL'})
    driver?:User
    ...
    @ManyToOne(type => Restaurant, restaurant => restaurant.orders,{nullable:true, onDelete:'SET NULL'})
